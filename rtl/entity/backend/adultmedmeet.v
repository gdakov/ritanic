...
//  output reg [3:0] smallConst; //signed
 ...
 //     opcode_main[7:2]==6'd15 && !instr[0]);
  ...
  assign isBasicAdd32=(!opcode_main[7] && opcode_main[6:4]==7 && instr[18]);
	...
	assign isBaseSpecLoad=((opcode_main[7:3]==5'b10011) && opcode_main[2:0]==0);
	assign isBaseSpecStore=((opcode_main[7:3]==5'b10011) && opcode_main[2:0]==1);
	assign isBaseIndexSpecLoad=((opcode_main[7:3]==5'b10011) && opcode_main[2:0]==2);
	assign isBaseIndexSpecStore=((opcode_main[7:3]==5'b10011) && opcode_main[2:0]==3);
...
? stsz_in : instr[11:8],1'b0};
      ...
      trien[18]=magic[0] && isBaseIndexSpecLoad | isBaseIndexSpecStore;
          pport[18]=PORT_LOAD;
	       poperation[18][6:0]={~(magic==4'b0111 && instr[57]),opcode_main[30],instr[11:8],1'b0};
         ...
         //   poperation[18][0]));
	       if (isBaseIndexSpecStore) pcalu[18]={1'b1,stsz_in};
          poperation[18][12]=1'b0;
          poperation[18][7:6]=2'b0;
	       prA_use[18]=1;
	       prT_use[18]=opcode_main[4]|~opcode_main[30];
	       prT_useF[18]=~(opcode_main[4]|~opcode_main[30]);
          //prT_isV[18]=~(opcode_main[7]|~opcode_main[0]) && fop_v({instr[11:8],1'b0});
          puseRs[18]=1'b1;
          prAlloc[18]=1'b0;
	       puseBConst[18]=1;
	       if (magic[2:0]!=3'b111) pconstant[18]=(magic[1:0]==2'b11) ? {{18+32{instr[38]}},instr[38:25]} : {{23+32{instr[29]}},instr[29:21]};
          perror[18]=2'b0;
          prT[18]=5'd16;
